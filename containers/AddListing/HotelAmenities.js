...
import { FormHeader, Title, Description, FormContent, FormAction } from './AddListing.style';
    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      <FormContent>
        <FormHeader>
          ...
          <Description>
            Add your hotel amenities , it can help travelers to choose their perfect hotel. Thanks.
          </Description>
        </FormHeader>
        <Row gutter={30}>
      ...
      <FormAction>
        <div className="inner-wrapper">
          <Button className="back-btn" htmlType="button" onClick={() => setStep(3)}>
            <IoIosArrowBack /> Back
          </Button>
