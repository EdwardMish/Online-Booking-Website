  ...
  return (
    <Element name="reviews" className="reviews">
      <ReviewWrapper>
        <HeaderSection>
          <RatingStatus>
            <Heading content={`${ratingCount} Reviews`} {...statusHeadingStyle} />
            <IoIosStar />
            <IoIosStar />
            <IoIosStar />
            <IoIosStar />
          ...
          <RatingSearch>
            <Search placeholder="Search reviews" onSearch={(value) => console.log(value)} />
        ...
        <Row gutter={20}>
          ...
          <Col sm={12} lg={5}>
            ...
            >
              ...
              <FilterElement>
                <Checkbox onChange={onChange}>
                  <Text content="Chinese (Sim.)" as="span" {...ratingLabelStyle} />
                </Checkbox>
              </FilterElement>
              {/* End of Filter Element */}
              ...
              <FilterElement>
                <Checkbox onChange={onChange}>
                  <Text content="Chinese (Trad.)" as="span" {...ratingLabelStyle} />
                </Checkbox>
              </FilterElement>
              {/* End of Filter Element */}
