...
export const GridCardAMBWrapper = styled.div`
  position: relative;
  border-radius: 5px;
  overflow: hidden;
  margin-bottom: 30px;
...
export const SPContentWrapper = styled.div`
  padding: 55px 15px 15px;
  border-bottom-left-radius: 6px;
  border-bottom-right-radius: 6px;
  background: linear-gradient(to bottom, #ffffff00 0%, #383a5e 80%, #383a5e 100%);
  transition: border-color 0.2s ease;
  display: flex;
...
export const AMBContentWrapper = styled.div`
  padding: 25px 0 15px;
  display: flex;
  justify-content: space-between;
  z-index: 9;
